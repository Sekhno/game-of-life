...
define(['./constants/ball-dirs.js', './constants/bricks-types.js'], function(BallDirs, BricksTypes){
     ...
     * @param width {Number} width paddle
     * @param height {Number} height paddle
     * @constructor
     */
     ...
     * @param raduis {Number} radius ball
     * @param dir {Number} direction ball
     * @param speed {Number} speed ball
     * @constructor
     */
    ...
    /**
     * @class Brick
     * @param x {Number} X coordinate of brick
     * @param y {Number} Y coordinate of brick
     * @param width {Number} Width brick
     * @param height {Number} Height brick
     * @param type {}
     * @constructor
     */
    ...
    /**
     * @class Bricks
     * @param hor_num {Number} Number horizontal bricks
     * @param vert_num {Number} Number vertical bricks
     * @param brick_width {Number} Width brick
     * @param brick_height {Number} Height brick
     * @constructor
     */
